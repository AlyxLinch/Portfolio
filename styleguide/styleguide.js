...
const controls = [
  ...
  { property: "--gradient-highlight-forest", label: "Forest glow", type: "color" },
  { property: "--gradient-highlight-plum", label: "Plum glow", type: "color" },
  { property: "--gradient-highlight-yellow", label: "Yellow glow", type: "color" },
  ...
  { property: "--gradient-radius", label: "Gradient radius", min: 0.35, max: 1.8, step: 0.05, unit: "em" },
